...
// This file contains explicit template instantiations for common monitor types
// and any non-template member functions if needed in the future

// Note: Since BaseDriver is a template class, most of its implementation
...
// template class BaseMonitor<Vhello_world_top, AdderTransaction>;
