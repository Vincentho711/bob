...
simulation::Task<> Init_Reset_Sequence::body() {
    auto init_reset_ctx = this->logger_.scoped_context("Init Reset Sequence");
    this->log_info("Starting Init Reset Sequence");
    ...
    this->log_info("Finished Init Reset Sequence");
}
...
simulation::Task<> Seq_Directed_WriteRead_All_Address_Increment::body() {
    ...
    this->log_info("Finished Write Read All Address Increment Sequence");
}
...
simulation::Task<> Seq_Directed_WriteRead_All_Address_Decrement::body() {
    ...
    this->log_info("Finished Write Read All Address Decrement Sequence");
}
