...
public:
    DualPortRamTopSequence(uint32_t addr_width, const std::string &name = "DualPortRamTopSequence", const bool enabled_debug = true) :
        DualPortRamBaseSequence(name, enabled_debug), addr_width_(addr_width) {};
